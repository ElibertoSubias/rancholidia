...
import { StyleSheet, View, TouchableOpacity, Image, ImageBackground, Platform } from 'react-native';
...
const imageLoading = { uri: "./assets/home.jpg" };
...
const HomeStackScreen = ({navigation}) => (
  <HomeStack.Navigator 
    screenOptions={{
      ...
      headerStyle: {
        backgroundColor: '#FCDB44', //Set Header color
      },
...
const NewItemStackScreen = ({navigation}) => (
  ...
  >
    <SearchStack.Screen name="Agregar ganado" component={NewItemScreen} />
  </SearchStack.Navigator>
);
...
const ListItemStackScreen = ({navigation}) => (
  ...
  >
    <SearchStack.Screen name="Listado" component={ListItemScreen} />
  </SearchStack.Navigator>
);
...
const HomeVisitStackScreen = ({navigation}) => (
  <ProfileStack.Navigator
    screenOptions={{
      ...
      headerRight: () => (
        <View style={{ flexDirection: 'row' }}>
          <TouchableOpacity style={{ width: 30, height: 30, marginLeft: 8 }}>
      ...
      // headerTintColor: '#fff', //Set Header text color
      headerTitleStyle: { flexDirection: 'row' },
    }}
  >
    <ProfileStack.Screen name="Inicio" component={HomeVisitScreen} />
    <ProfileStack.Screen name="Nosotros" component={HomeVisitScreen} />
    <ProfileStack.Screen name="Productos" component={HomeVisitScreen} />
    <ProfileStack.Screen name="Ganado" component={HomeVisitScreen} />
    <ProfileStack.Screen name="Agricultura" component={HomeVisitScreen} />
    <ProfileStack.Screen name="Socios" component={HomeVisitScreen} />
  </ProfileStack.Navigator>
);
...
const TabsScreen = () => (
  ...
  >
    ...
    <Tabs.Screen name="NewItem" component={NewItemStackScreen} />
    <Tabs.Screen name="ListItem" component={ListItemStackScreen} />
...
const DrawerVisit = createDrawerNavigator();
const DrawerScreenVisit = () => (
  <DrawerVisit.Navigator initialRouteName="Home">
    <DrawerVisit.Screen name="Home" component={HomeVisitStackScreen} />
    <DrawerVisit.Screen name="Nosotros" component={HomeVisitStackScreen} />
    <DrawerVisit.Screen name="Productos" component={HomeVisitStackScreen} />
    <DrawerVisit.Screen name="Ganado" component={HomeVisitStackScreen} />
    <DrawerVisit.Screen name="Agricultura" component={HomeVisitStackScreen} />
    <DrawerVisit.Screen name="Socios" component={AuthStackScreen} />
  </DrawerVisit.Navigator>
);
...
export default function App() {
  ...
  React.useEffect(() => {
    const getData = async () => {
      try {
        const jsonValue = await AsyncStorage.getItem('@rancho-lidia-123')
    ...
    return (
      <>
        <View style={styles.containerHome}>
          <ImageBackground source={require('./assets/splash.jpg')} style={styles.imageHome}>
          </ImageBackground>
        </View>
